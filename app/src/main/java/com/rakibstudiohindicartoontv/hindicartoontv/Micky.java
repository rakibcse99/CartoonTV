...
public class Micky extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.fragment_micky, container, false);


        progress=root.findViewById(R.id.Mickyprogress);
        recyclerView =root.findViewById(R.id.Mickyfg);
        return root;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Call<Playitemlist> videoDetailsRequset =
                (Call<Playitemlist>) dataService.getVideoPlaylist("snippet",api.micky , "50",
                        api.playerApiKey);
