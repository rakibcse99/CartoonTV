...
public class Littlebheem extends Fragment {


    private RecyclerView recyclerView;
    private Apiclass api;
    private VideoAdapterplaylist videoAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.fragment_littlebheem, container, false);


        progress=root.findViewById(R.id.Littlebheemprogress);
        recyclerView =root.findViewById(R.id.littlebheemfg);
        return root;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Call<Playitemlist> videoDetailsRequset =
                (Call<Playitemlist>) dataService.getVideoPlaylist("snippet",api.littlebheem , "50",
                        api.playerApiKey);
...
//                Toast.makeText(requireActivity(),"Poor Internet Connection", Toast.LENGTH_LONG).show();
    ...
    private void setUpRecyclerView(List<Item> items) {
        videoAdapter = new VideoAdapterplaylist(getContext(),items);
