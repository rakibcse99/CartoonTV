...
public class VirHindi extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.fragment_vir_hindi, container, false);
        progress=root.findViewById(R.id.Virhindiprogress);
        recyclerView =root.findViewById(R.id.VirHindifg);
        return root;
    }
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Call<Playitemlist> videoDetailsRequset =
                (Call<Playitemlist>) dataService.getVideoPlaylist("snippet",api.virApiKey , "50",
                        api.playerApiKey);
