...
import com.rakibstudiohindicartoontv.hindicartoontv.FoumascartoonActivity;
import com.rakibstudiohindicartoontv.hindicartoontv.FunnyCartoonActivity;
...
public class VideoAdapterplaylistFF extends RecyclerView.Adapter<VideoAdapterplaylistFF.videodetalsViewHolder> {
    private Context context;
    private List<Item> videoDetailsClassList;
    private String convert_date;


    public VideoAdapterplaylistFF(Context context, List<Item> videoDetailsClassList) {
    ...
    @NonNull
    @Override
    public VideoAdapterplaylistFF.videodetalsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.video_rownew, parent, false);
        //   view.setOnClickListener(listener,);
        return new VideoAdapterplaylistFF.videodetalsViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final VideoAdapterplaylistFF.videodetalsViewHolder holder, @SuppressLint("RecyclerView") final int position) {
...
//    Picasso.get().load(R.drawable.ic_menu_gallery).placeholder(R.drawable.ic_menu_gallery).into(holder.ImageThumb);
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent=new Intent(context, FoumascartoonActivity.class);
...
//            public void onClick(View v) {
//
//                final String videoID =videoDetailsClassList.get(position).getSnippet().getResourceId().getVideoId();
...
//        });
    ...
    public class videodetalsViewHolder extends ViewHolder {
...
//            share=itemView.findViewById(R.id.sharevd);
