...
public class BanglaAdapter extends RecyclerView.Adapter <BanglaAdapter.ImageViewHolder>{
    private Context mcontext;
    private List<StaticVideoClass> mUpload;


    public BanglaAdapter(Context mcontext, List<StaticVideoClass> mUpload) {
...
//        final String image =cureentUpload.getImageUrl()+"";
        ...
        Intent intent=new Intent(mcontext, BanglaCartoon.class);
