...
import com.rakibstudiohindicartoontv.hindicartoontv.HindiCartoon;
...
public class VideoAdapterplaylistH extends RecyclerView.Adapter<VideoAdapterplaylistH.videodetalsViewHolder> {
    private Context context;
    private List<Item> videoDetailsClassList;
    private String convert_date;


    public VideoAdapterplaylistH(Context context, List<Item> videoDetailsClassList) {
 ...
 holder.catagory.setText(videoDetailsClassList.get(position).getSnippet().getChannelTitle());
    ...
    holder.itemView.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            Intent intent=new Intent(context, HindiCartoon.class);
