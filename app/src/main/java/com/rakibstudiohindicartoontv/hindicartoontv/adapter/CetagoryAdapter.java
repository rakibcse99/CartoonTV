...
public class CetagoryAdapter extends RecyclerView.Adapter <CetagoryAdapter.ImageViewHolder>{
    private Context mcontext;
    private List<ImageClass>mUpload;

    public CetagoryAdapter(Context mcontext, List<ImageClass> mUpload) {
