...
public class HindiAdapter extends RecyclerView.Adapter <HindiAdapter.ImageViewHolder>{
    private Context mcontext;
    private List<StaticVideoClass> mUpload;


    public HindiAdapter(Context mcontext, List<StaticVideoClass> mUpload) {
...
//        final String image =cureentUpload.getImageUrl()+"";
        ...
        Intent intent=new Intent(mcontext, HindiCartoon.class);
