...
public class FunnyAdapter extends RecyclerView.Adapter <FunnyAdapter.ImageViewHolder>{
    private Context mcontext;
    private List<StaticVideoClass> mUpload;


    public FunnyAdapter(Context mcontext, List<StaticVideoClass> mUpload) {
...
//        final String image =cureentUpload.getImageUrl()+"";
        ...
        Intent intent=new Intent(mcontext, FunnyCartoonActivity.class);
