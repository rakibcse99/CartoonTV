...
public class VideoAdapterplaylistB extends RecyclerView.Adapter<VideoAdapterplaylistB.videodetalsViewHolder> {
    private Context context;
    private List<Item> videoDetailsClassList;
    private String convert_date;


    public VideoAdapterplaylistB(Context context, List<Item> videoDetailsClassList) {
...
if (videoDetailsClassList.get(position).getSnippet().getThumbnails().getMedium() ==null){
  holder.loadProgress.setVisibility(View.GONE);
    ...
    holder.catgory.setText("loding problem");
...
//    holder.textViewTitle.setText(videoDetailsClassList.get(position).getSnippet().getChannelTitle());
//    Picasso.get().load(videoDetailsClassList.get(position).getSnippet().getThumbnails()
//            .getMedium().getUrl()).into(holder.ImageThumb);
holder.catgory.setText(videoDetailsClassList.get(position).getSnippet().getChannelTitle());
    ...
    holder.itemView.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            Intent intent=new Intent(context, BanglaCartoon.class);
...
//            StartAppAd.showAd(context);
    ...
    public class videodetalsViewHolder extends ViewHolder {
        TextView textViewTitle,catgory;
...
//            share=itemView.findViewById(R.id.sharevd);
            catgory=(TextView)itemView.findViewById(R.id.catagory);
