...
public class VideoAdapterplaylist extends RecyclerView.Adapter<VideoAdapterplaylist.videodetalsViewHolder> {
    private Context context;
    private List<Item> videoDetailsClassList;
    private String convert_date;


    public VideoAdapterplaylist(Context context, List<Item> videoDetailsClassList) {
...
//    Picasso.get().load(R.drawable.ic_menu_gallery).placeholder(R.drawable.ic_menu_gallery).into(holder.ImageThumb);
    ...
    holder.itemView.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            Intent intent=new Intent(context, EnglishCartoon.class);
