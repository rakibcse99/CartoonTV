...
public class VideoAdapterplaylistF extends RecyclerView.Adapter<VideoAdapterplaylistF.videodetalsViewHolder> {
    private Context context;
    private List<Item> videoDetailsClassList;
    private String convert_date;


    public VideoAdapterplaylistF(Context context, List<Item> videoDetailsClassList) {
