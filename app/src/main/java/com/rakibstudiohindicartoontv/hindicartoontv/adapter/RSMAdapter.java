...
public class RSMAdapter extends RecyclerView.Adapter <RSMAdapter.ImageViewHolder>{
    private Context mcontext;
    private List<StaticVideoClass> mUpload;


    public RSMAdapter(Context mcontext, List<StaticVideoClass> mUpload) {
...
//        final String image =cureentUpload.getImageUrl()+"";
        ...
        Intent intent=new Intent(mcontext, PlayerFactivety.class);
