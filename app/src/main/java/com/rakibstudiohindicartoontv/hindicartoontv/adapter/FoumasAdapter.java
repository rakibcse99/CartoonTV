...
public class FoumasAdapter extends RecyclerView.Adapter <FoumasAdapter.ImageViewHolder>{
    private Context mcontext;
    private List<StaticVideoClass> mUpload;


    public FoumasAdapter(Context mcontext, List<StaticVideoClass> mUpload) {
...
//        final String image =cureentUpload.getImageUrl()+"";
        ...
        Intent intent=new Intent(mcontext, FoumascartoonActivity.class);
