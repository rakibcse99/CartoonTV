...
public class Shiva extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root=inflater.inflate(R.layout.fragment_shiva, container, false);
        progress=root.findViewById(R.id.shivaprogress);
        recyclerView =root.findViewById(R.id.shivafg);
        return root;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Call<Playitemlist> videoDetailsRequset =
                (Call<Playitemlist>) dataService.getVideoPlaylist("snippet",api.shiva , "50",
                        api.playerApiKey);
