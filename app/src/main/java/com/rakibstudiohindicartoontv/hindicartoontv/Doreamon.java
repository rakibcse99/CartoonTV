...
public class Doreamon extends Fragment {


    private RecyclerView recyclerView;
    private Apiclass api;
    private VideoAdapterplaylistFF videoAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.fragment_doreamon, container, false);
        progress=root.findViewById(R.id.doreamonprogress);
        recyclerView =root.findViewById(R.id.doreamonfg);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Call<Playitemlist> videoDetailsRequset =
                (Call<Playitemlist>) dataService.getVideoPlaylist("snippet",api.doreamanApiKey , "50",
                        api.playerApiKey);
...
//                Toast.makeText(requireActivity(),"Poor Internet Connection", Toast.LENGTH_LONG).show();
    ...
    private void setUpRecyclerView(List<Item> items) {
        videoAdapter = new VideoAdapterplaylistFF(getContext(),items);
