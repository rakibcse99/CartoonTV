...
public class JanCartoon extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_jan_cartoon, container, false);
        progress=root.findViewById(R.id.janCartoonprogress);
        recyclerView =root.findViewById(R.id.jancartoonfg);
        return root;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Call<Playitemlist> videoDetailsRequset =
                (Call<Playitemlist>) dataService.getVideoPlaylist("snippet",api.jancartoon , "50",
                        api.playerApiKey);
