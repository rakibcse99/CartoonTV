...
public class Motupatlu extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.fragment_motupatlu, container, false);
        progress=root.findViewById(R.id.Motuprogress);
        recyclerView =root.findViewById(R.id.Motufg);
        return root;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Call<Playitemlist> videoDetailsRequset =
                (Call<Playitemlist>) dataService.getVideoPlaylist("snippet",api.motutaluapikeyhindi , "50",
                        api.playerApiKey);
