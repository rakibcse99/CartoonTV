...
public class Pokemon extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        progress=root.findViewById(R.id.Pokemonprogress);
        recyclerView =root.findViewById(R.id.Pokemonfg);
        return root;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Call<Playitemlist> videoDetailsRequset =
                (Call<Playitemlist>) dataService.getVideoPlaylist("snippet",api.pokemon , "50",
                        api.playerApiKey);
