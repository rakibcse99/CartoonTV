...
import com.rakibstudiohindicartoontv.hindicartoontv.adapter.VideoAdapterplaylistFF;
...
public class Kisena extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.fragment_kisena, container, false);
        progress=root.findViewById(R.id.kisnaprogress);
        recyclerView =root.findViewById(R.id.kisnafg);
        return root;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Call<Playitemlist> videoDetailsRequset =
                (Call<Playitemlist>) dataService.getVideoPlaylist("snippet",api.kisna , "50",
                        api.playerApiKey);
