...
public class Looney extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.fragment_looney, container, false);


        progress=root.findViewById(R.id.looneyprogress);
        recyclerView =root.findViewById(R.id.looneyfg);
        return root;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Call<Playitemlist> videoDetailsRequset =
                (Call<Playitemlist>) dataService.getVideoPlaylist("snippet",api.looneyApiKey , "50",
                        api.playerApiKey);
