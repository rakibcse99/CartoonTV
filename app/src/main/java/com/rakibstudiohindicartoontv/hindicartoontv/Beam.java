...
public class Beam extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.fragment_more_over, container, false);

        progress=root.findViewById(R.id.moreOverprogress);
        recyclerView =root.findViewById(R.id.moreOverfg);
        return root;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Call<Playitemlist> videoDetailsRequset =
                (Call<Playitemlist>) dataService.getVideoPlaylist("snippet",api.mrbeamApiKey , "50",
                        api.playerApiKey);
