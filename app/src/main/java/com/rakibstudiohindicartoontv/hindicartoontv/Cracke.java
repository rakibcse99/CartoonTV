...
public class Cracke extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.fragment_cracke, container, false);
        progress=root.findViewById(R.id.Crackprogress);
        recyclerView =root.findViewById(R.id.Cracknfg);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Call<Playitemlist> videoDetailsRequset =
                (Call<Playitemlist>) dataService.getVideoPlaylist("snippet",api.Crack , "50",
                        api.playerApiKey);
