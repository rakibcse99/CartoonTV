...
public class BabluDablu extends Fragment {

    private RecyclerView recyclerView;
    private Apiclass api;
    private VideoAdapterplaylistHB videoAdapter;
    private ProgressBar babluprogress;
    public BabluDablu() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
     ...
     View root= inflater.inflate(R.layout.fragment_bablu_dablu, container, false);
        babluprogress=root.findViewById(R.id.babluDabluprogress);
        recyclerView =root.findViewById(R.id.Bablufg);
        return  root;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Call<Playitemlist> videoDetailsRequset =
                (Call<Playitemlist>) dataService.getVideoPlaylist("snippet",api.babludabluApiKey , "50",
                        api.playerApiKey);
...
//                         progressDoalog.dismiss();
                        babluprogress.setVisibility(View.GONE);
