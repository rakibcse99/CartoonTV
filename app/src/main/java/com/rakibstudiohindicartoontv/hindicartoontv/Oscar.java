...
public class Oscar extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.fragment_oscar, container, false);


        progress=root.findViewById(R.id.Oscarprogress);
        recyclerView =root.findViewById(R.id.Oscarfg);
        return root;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Call<Playitemlist> videoDetailsRequset =
                (Call<Playitemlist>) dataService.getVideoPlaylist("snippet",api.Oscar , "50",
                        api.playerApiKey);
