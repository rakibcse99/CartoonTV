...
public class Virbangla extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.fragment_virbangla, container, false);
        progress=root.findViewById(R.id.virbanglaprogress);
        recyclerView =root.findViewById(R.id.virbanglafg);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Call<Playitemlist> videoDetailsRequset =
                (Call<Playitemlist>) dataService.getVideoPlaylist("snippet",api.virbanglaApiKey , "50",
                        api.playerApiKey);
