...
public class Tom extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.fragment_tom, container, false);

        progress=root.findViewById(R.id.Tomprogress);
        recyclerView =root.findViewById(R.id.Tomfg);
        return root;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Call<Playitemlist> videoDetailsRequset =
                (Call<Playitemlist>) dataService.getVideoPlaylist("snippet",api.tomandjeryApiKey , "50",
                        api.playerApiKey);
