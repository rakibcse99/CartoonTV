...
public class Batiza extends Fragment {
...
private Context context;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.fragment_batiza, container, false);


        progress=root.findViewById(R.id.Dragonprogress);
        recyclerView =root.findViewById(R.id.Dradonfg);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Call<Playitemlist> videoDetailsRequset =
                (Call<Playitemlist>) dataService.getVideoPlaylist("snippet",api.batija , "50",
                        api.playerApiKey);
