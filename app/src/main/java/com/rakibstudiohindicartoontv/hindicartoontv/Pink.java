...
public class Pink extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.fragment_pink, container, false);
        progress=root.findViewById(R.id.Pinkprogress);
        recyclerView =root.findViewById(R.id.Pinkfg);
        return root;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Call<Playitemlist> videoDetailsRequset =
                (Call<Playitemlist>) dataService.getVideoPlaylist("snippet",api.pink , "50",
                        api.playerApiKey);
