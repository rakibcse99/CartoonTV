...
import com.rakibstudiohindicartoontv.hindicartoontv.adapter.VideoAdapterplaylistHB;
...
public class Chottabheem extends Fragment {
    private RecyclerView recyclerView;
    private Apiclass api;
    private VideoAdapterplaylistHB videoAdapter;
    private ProgressBar chottabheemprogress;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.fragment_chottabheem, container, false);

        chottabheemprogress=root.findViewById(R.id.chottabheemprogress);
        recyclerView =root.findViewById(R.id.chottabheemfg);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Call<Playitemlist> videoDetailsRequset =
                (Call<Playitemlist>) dataService.getVideoPlaylist("snippet",api.chotabhemApiKey , "50",
                        api.playerApiKey);
...
//                         progressDoalog.dismiss();
                        chottabheemprogress.setVisibility(View.GONE);
...
//                Toast.makeText(requireActivity(),"Poor Internet Connection", Toast.LENGTH_LONG).show();
    ...
    private void setUpRecyclerView(List<Item> items) {
        videoAdapter = new VideoAdapterplaylistHB(getContext(),items);
