...
public class Simba extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.fragment_simba, container, false);
        progress=root.findViewById(R.id.Simbaprogress);
        recyclerView =root.findViewById(R.id.Simbafg);
        return root;
    }
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Call<Playitemlist> videoDetailsRequset =
                (Call<Playitemlist>) dataService.getVideoPlaylist("snippet",api.simba , "50",
                        api.playerApiKey);
