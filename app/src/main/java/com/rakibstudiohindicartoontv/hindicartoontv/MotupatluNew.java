...
import com.rakibstudiohindicartoontv.hindicartoontv.adapter.VideoAdapterplaylistF;
import com.rakibstudiohindicartoontv.hindicartoontv.adapter.VideoAdapterplaylistNew;
...
public class MotupatluNew extends Fragment {
    private RecyclerView recyclerView;
    private Apiclass api;
    private VideoAdapterplaylistNew videoAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Inflate the layout for this fragment
         View root=inflater.inflate(R.layout.fragment_motupatlu_new, container, false);
        progress=root.findViewById(R.id.motunewprogress);
        recyclerView =root.findViewById(R.id.motunewfg);
        return root;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Call<Playitemlist> videoDetailsRequset =
                (Call<Playitemlist>) dataService.getVideoPlaylist("snippet",api.motupatlu , "50",
                        api.playerApiKey);
...
//                Toast.makeText(requireActivity(),"Poor Internet Connection", Toast.LENGTH_LONG).show();
    ...
    private void setUpRecyclerView(List<Item> items) {
        videoAdapter = new VideoAdapterplaylistNew(getContext(),items);
