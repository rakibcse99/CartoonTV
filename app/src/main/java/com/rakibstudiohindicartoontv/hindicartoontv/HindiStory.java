...
public class HindiStory extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.hindistoris, container, false);

        progress=root.findViewById(R.id.Shigamprogress);
        recyclerView =root.findViewById(R.id.Shigamfg);
        return root;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Call<Playitemlist> videoDetailsRequset =
                (Call<Playitemlist>) dataService.getVideoPlaylist("snippet",api.HindiStory , "50",
                        api.playerApiKey);
