...
import com.rakibstudiohindicartoontv.hindicartoontv.adapter.VideoAdapterplaylistB;
...
public class Banglarupkotha extends Fragment {


    private RecyclerView recyclerView;
    private Apiclass api;
    private VideoAdapterplaylistB videoAdapter;
    private ProgressBar banglaprogress;
    public Banglarupkotha() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root=inflater.inflate(R.layout.fragment_banglarupkotha, container, false);

        banglaprogress=root.findViewById(R.id.Banglarupkothaprogress);
        recyclerView =root.findViewById(R.id.Banglarupkothafg);
        return root;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Call<Playitemlist> videoDetailsRequset =
                (Call<Playitemlist>) dataService.getVideoPlaylist("snippet",api.banglabb , "50",
                        api.playerApiKey);
...
//                         progressDoalog.dismiss();
                        banglaprogress.setVisibility(View.GONE);
...
//                Toast.makeText(requireActivity(),"Poor Internet Connection", Toast.LENGTH_LONG).show();
    ...
    private void setUpRecyclerView(List<Item> items) {
        videoAdapter = new VideoAdapterplaylistB(getContext(),items);
