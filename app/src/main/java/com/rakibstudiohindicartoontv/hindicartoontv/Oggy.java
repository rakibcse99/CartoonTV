...
public class Oggy extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.fragment_oggy, container, false);

        progress=root.findViewById(R.id.Oggyprogress);
        recyclerView =root.findViewById(R.id.oggyfg);
        return root;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Call<Playitemlist> videoDetailsRequset =
                (Call<Playitemlist>) dataService.getVideoPlaylist("snippet",api.Oggy , "50",
                        api.playerApiKey);
