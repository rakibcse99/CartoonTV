...
public class Rudra extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      View root= inflater.inflate(R.layout.fragment_rudra, container, false);
        progress=root.findViewById(R.id.rudraprogress);
        recyclerView =root.findViewById(R.id.rudrafg);
        return root;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Call<Playitemlist> videoDetailsRequset =
                (Call<Playitemlist>) dataService.getVideoPlaylist("snippet",api.rudra , "50",
                        api.playerApiKey);
