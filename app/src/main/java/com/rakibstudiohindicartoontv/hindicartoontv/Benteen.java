...
public class Benteen extends Fragment {
    private RecyclerView recyclerView;
    private Apiclass api;
    private VideoAdapterplaylistF videoAdapter;
    private ProgressBar benprogress;
    public Benteen() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      View root=inflater.inflate(R.layout.fragment_benteen, container, false);

        benprogress=root.findViewById(R.id.benprogress);
        recyclerView =root.findViewById(R.id.benfg);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Call<Playitemlist> videoDetailsRequset =
                (Call<Playitemlist>) dataService.getVideoPlaylist("snippet",api.ben10 , "50",
                        api.playerApiKey);
...
//                         progressDoalog.dismiss();
                        benprogress.setVisibility(View.GONE);
...
//                Toast.makeText(requireActivity(),"Poor Internet Connection", Toast.LENGTH_LONG).show();
    ...
    private void setUpRecyclerView(List<Item> items) {
        videoAdapter = new VideoAdapterplaylistF(getContext(),items);
