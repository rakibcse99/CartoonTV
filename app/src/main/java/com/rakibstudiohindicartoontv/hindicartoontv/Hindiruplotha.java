...
public class Hindiruplotha extends Fragment {
    private RecyclerView recyclerView;
    private Apiclass api;
    private VideoAdapterplaylistH videoAdapter;
    private ProgressBar progress;

    public Hindiruplotha() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.fragment_hindiruplotha, container, false);

        progress=root.findViewById(R.id.HindiRupkothaprogress);
        recyclerView =root.findViewById(R.id.hindiruplothafg);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Call<Playitemlist> videoDetailsRequset =
                (Call<Playitemlist>) dataService.getVideoPlaylist("snippet",api.hindirupkotha , "50",
                        api.playerApiKey);
