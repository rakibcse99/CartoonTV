...
public class Larva extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View root=inflater.inflate(R.layout.fragment_larva, container, false);

        progress=root.findViewById(R.id.Larvaprogress);
        recyclerView =root.findViewById(R.id.Larvafg);
        return root;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Call<Playitemlist> videoDetailsRequset =
                (Call<Playitemlist>) dataService.getVideoPlaylist("snippet",api.Larva , "50",
                        api.playerApiKey);
